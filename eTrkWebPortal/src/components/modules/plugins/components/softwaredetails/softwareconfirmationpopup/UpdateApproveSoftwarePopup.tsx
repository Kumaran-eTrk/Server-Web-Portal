...
export const UpdateApproveSoftwarePopup = ({
  setUpdateSoftwareReject,
  softwareId,
}: {
  setUpdateSoftwareReject: any;
  softwareId: string;
}) => {
        ...
        <DialogBody>
          ...
          <DialogContent className={styles1.content}>
            ...
            <Input
              ...
              value={remarks}
            />
            Are you sure want to move this software from rejected to approved?
          </DialogContent>
          <DialogActions>
            <DialogTrigger disableButtonEnhancement>
